Public Class abm_primera_dosis
    Dim CRUD As New CRUD
    Private Sub btnEnviar_Click(sender As Object, e As EventArgs) Handles btnEnviar.Click
        If CRUD.ValidaSiExiste(tDNI.Text) Then
            If Len(Trim(cbVacuna.Text)) > 0 Then
                If CRUD.ValidaVacunado1(tDNI.Text) = False Then
                    Try
                        Dim Sql As String = "Insert Into Clientes_Vacuna_1 (DNI, Valoraciones, Vacuna, Fecha) Select " & tDNI.Text & ", '" & tValoraciones.Text & "', '" & cbVacuna.Text & "','" & dtpFecha.Text & "'"
                    ...
                    End Try
                Else
                    MsgBox("Esta persona ya ha recibido la segunda dosis")
                End If
            Else
